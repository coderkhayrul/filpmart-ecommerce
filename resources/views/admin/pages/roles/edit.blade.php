    ...
    <div class="col-md-12">
        <div class="card border border-primary">
            <div class="card-header bg-transparent border-primary d-flex justify-content-between">
                <h5 class="my-0 text-primary align-middle"><i class="mdi mdi-bullseye-arrow me-3"></i>Update Role For {{ $role->name }}</h5>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-check form-switch form-switch-md mb-3" dir="ltr">
                                            <input {{ $role->hasPermissionTo($permission->name) ? 'checked' : '' }} name="permission[]" value="{{ $permission->name }}" type="checkbox" class="form-check-input" id="{{ $permission->name }}">
