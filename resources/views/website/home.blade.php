    ...
    <div id="product-tabs-slider" class="scroll-tabs outer-top-vs wow fadeInUp">
        <div class="more-info-tab clearfix ">
            ...
            <ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
                ...
                @php
                    $categories = App\Models\Category::where('pro_cat_status', 1)->limit(3)->get();
                @endphp
            ...
            <div class="tab-pane" id="{{ $category->pro_cat_id }}">
                <div class="product-slider">
                    <div class="owl-carousel home-owl-carousel custom-carousel owl-theme">
                        @php
                            $products = App\Models\Product::where('product_status',1)->where('pro_category_id',$category->pro_cat_id)->get();
                        @endphp
                        {{-- @dd($products) --}}
                        @foreach ($products as $product)
                        <div class="item item-carousel">
