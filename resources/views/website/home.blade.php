...
<div class="col-xs-12 col-sm-12 col-md-9 homebanner-holder">
    ...
    <!-- ============================================== FEATURED PRODUCTS ============================================== -->
    @php
        $feature_product = App\Models\Product::where('product_status', 1)->where('product_feature', 1)->orderby('product_id', 'DESC')->get();
    @endphp
            ...
            <div class="item item-carousel">
                <div class="products">
                    <div class="product">
                        <div class="product-image">
                            <div class="image"> <a href="detail.html"><img
                                        src="{{ asset('backend/uploads/product/'.$product->product_image) }}" alt=""></a>
                            </div>
                            <!-- /.image -->
                        ...
                        <div class="product-info text-left">
                            ...
                            <div class="rating rateit-small"></div>
                            <div class="description"></div>
                            <div class="product-price"> <span class="price"> $ {{ $product->product_price }} </span> <span
                                    class="price-before-discount">$ {{ $product->product_discount_price }}</span> </div>
                            <!-- /.product-price -->
    ...
    <section class="section wow fadeInUp new-arriavls">
        ...
        <div class="owl-carousel home-owl-carousel custom-carousel owl-theme outer-top-xs">
            @php
                $new_product = App\Models\Product::where('product_status', 1)->orderby('product_id', 'DESC')->get();
            @endphp
