            ...
            <ul class="nav">
                ...
                <li class="dropdown menu-item">
                    ...
                    @php
                        ...
                        $totalsubCategories = App\Models\Category::where('pro_cat_status', 1)->where('pro_cat_parent',$cid)->count();
                    @endphp
                            ...
                            <div class="row">
                                <div class="col-sm-6 col-md-6">
                                    <ul class="links list-unstyled">
                                        @foreach($subCategories as $childcate)
                                        <li><a href="#">{{ $childcate->pro_cat_name }} </a></li>
                                        @endforeach
                                    </ul>
                                </div>
                                <!-- /.col -->
                                    ...
                                    <div class="col col-xs-5">
                                        <div class="product-image">
                                            <div class="image"> <a href="#"> <img
                                                        src="{{ asset('frontend') }}/images/products/p30.jpg" alt="">
                                                </a> </div>
                                            <!-- /.image -->
                            ...
                            <div class="product-micro">
                                <div class="row product-micro-row">
                                    <div class="col col-xs-5">
                                        <div class="product-image">
                                            <div class="image"> <a href="#"> <img
                                                        src="{{ asset('frontend') }}/images/products/p29.jpg" alt="">
                                                </a> </div>
                                            <!-- /.image -->
                            ...
                            <div class="product-micro">
                                <div class="row product-micro-row">
                                    <div class="col col-xs-5">
                                        <div class="product-image">
                                            <div class="image"> <a href="#"> <img
                                                        src="{{ asset('frontend') }}/images/products/p28.jpg" alt="">
                                                </a> </div>
                                            <!-- /.image -->
                            ...
                            <div class="product-micro">
                                <div class="row product-micro-row">
                                    <div class="col col-xs-5">
                                        <div class="product-image">
                                            <div class="image"> <a href="#"> <img
                                                        src="{{ asset('frontend') }}/images/products/p27.jpg" alt="">
                                                </a> </div>
                                            <!-- /.image -->
                            ...
                            <div class="product-micro">
                                <div class="row product-micro-row">
                                    <div class="col col-xs-5">
                                        <div class="product-image">
                                            <div class="image"> <a href="#"> <img
                                                        src="{{ asset('frontend') }}/images/products/p26.jpg" alt="">
                                                </a> </div>
                                            <!-- /.image -->
                            ...
                            <div class="product-micro">
                                <div class="row product-micro-row">
                                    <div class="col col-xs-5">
                                        <div class="product-image">
                                            <div class="image"> <a href="#"> <img
                                                        src="{{ asset('frontend') }}/images/products/p25.jpg" alt="">
                                                </a> </div>
                                            <!-- /.image -->
                            ...
                            <div class="product-micro">
                                <div class="row product-micro-row">
                                    <div class="col col-xs-5">
                                        <div class="product-image">
                                            <div class="image"> <a href="#"> <img
                                                        src="{{ asset('frontend') }}/images/products/p24.jpg" alt="">
                                                </a> </div>
                                            <!-- /.image -->
                            ...
                            <div class="product-micro">
                                <div class="row product-micro-row">
                                    <div class="col col-xs-5">
                                        <div class="product-image">
                                            <div class="image"> <a href="#"> <img
                                                        src="{{ asset('frontend') }}/images/products/p23.jpg" alt="">
                                                </a> </div>
                                            <!-- /.image -->
                            ...
                            <div class="product-micro">
                                <div class="row product-micro-row">
                                    <div class="col col-xs-5">
                                        <div class="product-image">
                                            <div class="image"> <a href="#"> <img
                                                        src="{{ asset('frontend') }}/images/products/p22.jpg" alt="">
                                                </a> </div>
                                            <!-- /.image -->
                            ...
                            <div class="product-micro">
                                <div class="row product-micro-row">
                                    <div class="col col-xs-5">
                                        <div class="product-image">
                                            <div class="image"> <a href="#"> <img
                                                        src="{{ asset('frontend') }}/images/products/p15.jpg" alt="">
                                                </a> </div>
                                            <!-- /.image -->
                            ...
                            <div class="product-micro">
                                <div class="row product-micro-row">
                                    <div class="col col-xs-5">
                                        <div class="product-image">
                                            <div class="image"> <a href="#"> <img
                                                        src="{{ asset('frontend') }}/images/products/p18.jpg" alt="">
                                                </a> </div>
                                            <!-- /.image -->
                            ...
                            <div class="product-micro">
                                <div class="row product-micro-row">
                                    <div class="col col-xs-5">
                                        <div class="product-image">
                                            <div class="image"> <a href="#"> <img
                                                        src="{{ asset('frontend') }}/images/products/p17.jpg" alt="">
                                                </a> </div>
                                            <!-- /.image -->
                            ...
                            <div class="product-micro">
                                <div class="row product-micro-row">
                                    <div class="col col-xs-5">
                                        <div class="product-image">
                                            <div class="image"> <a href="#"> <img
                                                        src="{{ asset('frontend') }}/images/products/p16.jpg" alt="">
                                                </a> </div>
                                            <!-- /.image -->
                            ...
                            <div class="product-micro">
                                <div class="row product-micro-row">
                                    <div class="col col-xs-5">
                                        <div class="product-image">
                                            <div class="image"> <a href="#"> <img
                                                        src="{{ asset('frontend') }}/images/products/p14.jpg" alt="">
                                                    <div class="zoom-overlay"></div>
                                                </a> </div>
                                            <!-- /.image -->
